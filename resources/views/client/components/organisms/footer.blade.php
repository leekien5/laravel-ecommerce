    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Company</h6>
          <a href="#" class="text-decoration-none"><p>About Us</p></a>
          <a href="#" class="text-decoration-none"><p>Product</p></a>
          <a href="#" class="text-decoration-none text-dark"><p>Address</p></a>
        </div>
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Support</h6>
          <a href="#" class="text-decoration-none text-dark"><p>FAQ</p></a>
          <a href="#" class="text-decoration-none text-dark"><p>Shipping & Returns</p></a>
          <a href="#" class="text-decoration-none text-dark"><p>Warranty</p></a>
        </div>
        <div class="col-lg-2 col-md-2 col-6 d-flex flex-column">
          ...
          <p class="d-flex align-items-center"><img src="{{ asset('client/img/icon-email.png') }}" alt="" class="img-fluid me-2">admin{!! '@'.str_replace(' ', '', strtolower($shop->name_shop)) !!}.com</p>
