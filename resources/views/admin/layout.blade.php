            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('subcategory') || request()->routeIs('subcategoryCreate') ? 'active' : '' }}">
                            <a href="{{route('subcategory')}}" class='sidebar-link'>
                                <i class="bi bi-stack"></i>
