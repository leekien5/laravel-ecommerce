...
Route::controller(ClientController::class)->group(function(){
    ...
    Route::get('/category/{category}/{subcategory}', 'subcategoryProducts')->name('clientSubcategoryProducts');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(SubcategoryController::class)->group(function() {
        Route::get('/admin/sub-category', 'index')->name('subcategory');
        Route::get('/admin/sub-category/create', 'create')->name('subcategoryCreate');
        Route::post('/admin/sub-category/check', 'check')->name('subcategoryCheck');
        Route::post('/admin/sub-category/save', 'save')->name('subcategorySave');
        Route::get('/admin/sub-category/delete/{id}/{path}', 'delete')->name('subcategoryDelete');
        Route::get('/admin/get-sub-category-by-category-id/{id}', 'getSubcategoryByCategoryId')->name('subcategoryByCategoryId');
    });
