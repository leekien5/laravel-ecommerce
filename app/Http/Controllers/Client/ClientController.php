...
class ClientController extends Controller
{
    ...
    public function subcategory($category)
    {
        $data = [
            'shop' => Shop::first(),
            'subcategory' => Subcategory::where('category_id', $category)->paginate(12),
            'title' => 'Subcategory - ' . str_replace('-', ' ', ucwords($category))
        ];

        return view('client.subcategory', $data);
    }
    ...
    public function categoryProducts($categoryName)
    {
        ...
        $data = [
            ...
            'title' => 'Category - ' . str_replace('-', ' ', ucwords($categoryName))
        ];

        return view('client.categoryProducts', $data);
    }

    public function subcategoryProducts($categoryName, $subcategoryName)
    {   
        $category = Category::where('name', $categoryName)->first();
        ...
        return view('client.subcategoryProducts', $data);
    }
